package dev.spring.security.controller;
...
import dev.spring.security.entite.InfosAuthentification;
...
public class AuthentificationCtrl {
	...
	public ResponseEntity authenticate(@RequestBody InfosAuthentification authenticationRequest,
		...
		UsernamePasswordAuthenticationToken usernamePasswordAuthenticationToken = new UsernamePasswordAuthenticationToken(
				authenticationRequest.getNomUtilisateur(), authenticationRequest.getMotDePasse());
